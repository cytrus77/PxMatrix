...
void print_time(uint8_t xpos, uint8_t ypos, uint8_t colorR, uint8_t colorG, uint8_t colorB)
{
    display.setTextWrap(false);  // we don't wrap text so it scrolls nicely
    display.setTextSize(1);
    display.setRotation(0);
...
void loop() {
//  scroll_text(1,50,"TOBIX to LAMERIX!",250,0,0);
  display.clearDisplay();
//  scroll_text(20,50,"Citrus Tech WITA",0,0,250);

  print_time(10, 20, 50,100,250);
